...
def banner(console):
    ...
    console.print(f"             [bold green]𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐁𝐎𝐓 [/bold green]: [bold cyan]@CarParkingTool_bot[/bold cyan] 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 [bold cyan]@CPMAizal[/bold cyan]") 
    console.print("[bold][red]==================================================================[/red][/bold]")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold green]{01}[/bold green]: [bold green]Change Money[/bold cyan]             [bold red]1.000[/bold red]")

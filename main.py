...
def banner(console):
    ...
    console.print("[bold green]♕ CPMAizal[/bold green]: Dont Copy Otherwise I Will Fuck Your Mother And Sister.")
    ...
    console.print("[bold yellow]! Note[/bold yellow]: اس ٹول کا مالک CPMAizal ہے۔ !.", end="\n\n")
